<header class="row">
    <?php Tags::simple_header("Admin Page", "- ". $this->request->session->get('usuario_session')->nombre);?>      
    
    <?php Tags::navigation_menu("pills"); ?>
    <?php Tags::nav_item("Home", BASEURL . "admin", $menu == "home" ? "active" : NULL); ?>
    <?php Tags::nav_item("Usuarios", BASEURL . "admin/usuarios", $menu == "usuarios" ? "active" : NULL); ?>
    <?php Tags::nav_item("Blog", BASEURL . "admin/blog", $menu == "blog" ? "active" : NULL); ?>
    <?php Tags::nav_item_drop_down($this->request->session->get('usuario_session')->usuario, TRUE); ?>
